            ...
            ?>
                ...
                <table style="font-size:12px;" class="jquerydatatable">
                    <thead>
                        ...
                        <td class="left" style="width:19%;">Status</td>
                        <td class="center" style="width:16%;" colspan="4"></td>
                    </thead>
                    <?php
                        $count = 0;
                    ...
                    ?>
                        <tr <?php if ($count % 2 == 0) { echo 'style="background-color: #CCCCCC;"'; } ?>>
                            ...
                            <td class="left"><?=$respostaEdital->get('id')?></td>
                            ...
                            <td class="center"><a class="post btn dark_green" id="<?=$respostaEdital->get('id')?>" href="<?=APP_URL?>/admin/resposta-edital/action/aprove"><i class="fa fa-check-circle-o"></i></a></td>
                            <td class="center"><a class="post btn black" id="<?=$respostaEdital->get('id')?>" href="<?=APP_URL?>/admin/resposta-edital/action/pre-select"><i class="fa fa-dot-circle-o"></a></td>
                            <td class="center"><a class="post btn dark_red" id="<?=$respostaEdital->get('id')?>" href="<?=APP_URL?>/admin/resposta-edital/action/deny"><i class="fa fa-times-circle-o"></i></a></td>
                        </tr>
                    <?php 
                            $count++; 
                        endforeach;
